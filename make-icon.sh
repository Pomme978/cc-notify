#!/bin/bash
# Génère cc-notify-icon.png et cc-notify.icns à partir du glyphe officiel
...
iconutil -c icns .build-icon.iconset -o cc-notify.icns
rm -rf .build-icon.iconset .icon-tmp.svg

echo "cc-notify-icon.png ($(sips -g pixelWidth cc-notify-icon.png | tail -1 | tr -d ' ')) et cc-notify.icns générés"
